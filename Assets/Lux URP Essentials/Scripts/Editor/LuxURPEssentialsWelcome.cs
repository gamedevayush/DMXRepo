		...
		public void OnGUI()
		{
			...
			GUILayout.BeginHorizontal();
				...
				EditorGUILayout.LabelField(
					"Currently installed: Version 1.81 for URP 11.0.", _style_bodytxt);
				GUILayout.Space(16);
			GUILayout.EndHorizontal();
			...
			GUILayout.BeginHorizontal();
				GUILayout.Space(16);
				EditorGUILayout.LabelField(
					"The package you have downloaded from the asset store installed shaders compatible with URP 11.0. " + 
