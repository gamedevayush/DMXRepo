...
// color.rgb = dot(inputData.normalWS, bentNormal); // * 0.5 + 0.5;
        ...
        //  Shadow caster specific input
            ...
            VertexOutputShadow ShadowPassVertex(VertexInput input)
            {
            ...
            half4 ShadowPassFragment(VertexOutputShadow input, half facing : VFACE) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(input);
                UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input);
        ...
        Pass
        {
            ...
            half4 DepthOnlyFragment(VertexOutput input) : SV_TARGET
            {
                ...
                //  LOD crossfading
                    ...
                    //  Parallax
                        half3 viewDirTS = SafeNormalize(input.viewDirTS); //SafeNormalize( mul(tangentSpaceRotation, viewDirWS) );
